...
public class old_pistol : Weapon
{
    ...
    public void Start()
    {
        shoot_handle = player.GetComponent<PolygonFPSControler>().ShootHandle;
        recyle_particles_performance = GameObject.FindGameObjectWithTag("rycle");
        
        change_equipment();
        _3rd_view = player.GetComponent<PolygonFPSControler>()._3rd;
    ...
    void Update()
    {
        ...
        running = player.GetComponent<PolygonFPSControler>().running;
        walking = player.GetComponent<PolygonFPSControler>().walking;
        walking_side = player.GetComponent<PolygonFPSControler>().walking_side;
        duck_walk = player.GetComponent<PolygonFPSControler>().duck_walk;
        reload = player.GetComponent<PolygonFPSControler>().reload;
        cam_toggled = player.GetComponent<PolygonFPSControler>().cam_toggled;
    ...
    public void Input_Status()
    {
        ...
        {
            _3rd_view = true;
            player.GetComponent<PolygonFPSControler>()._3rd = false;
            player.GetComponent<PolygonFPSControler>().ThirdPersonStatus();
        }
        else
        {
            _3rd_view = false;
            player.GetComponent<PolygonFPSControler>()._3rd = true;
            player.GetComponent<PolygonFPSControler>().ThirdPersonStatus();
        }
    ...
    public IEnumerator shoot()
    {
        ...
        {
            player.GetComponent<PolygonFPSControler>().vertical_float_spread = -add_ver_force;
            player.GetComponent<PolygonFPSControler>().horizontal_float_spread = add_hor_force;
        }
        ...
        if (suppressor_a_bool || suppressor_c_bool || suppressor_d_bool)
        {
            player.GetComponent<PolygonFPSControler>().vertical_float_spread = -add_ver_force / 3;
            player.GetComponent<PolygonFPSControler>().horizontal_float_spread = add_hor_force / 3;
        }
