...
public class PolygonFPSControler : MonoBehaviour
{
    ...
    public GameObject VerticalAimBoneDefault;
    ...
    private bool _isAK = false;
    private bool _isPistol = true;

    private void Start()
    {
        SavedRotationX = VerticalAimBoneDefault.transform.eulerAngles.x;
    ...
    public void aimming()
    {
        ...
        transform.eulerAngles = new Vector3(transform.eulerAngles.x, (transform.eulerAngles.y + add_hor) + (Input.GetAxis("Mouse X") * add_speed_aim) * Time.deltaTime * HorizontalSpeed, transform.eulerAngles.z);



        Vector3 rot = new Vector3((SavedRotationX + add_ver) - (Input.GetAxis("Mouse Y") * add_speed_aim) * Time.deltaTime * VerticalSpeed, VerticalAimBoneDefault.transform.eulerAngles.y, VerticalAimBoneDefault.transform.eulerAngles.z);
        ...
        SavedRotationX = rot.x;

        VerticalAimBoneDefault.transform.eulerAngles = rot;
    ...
    public void walk_execute()
    {
        ...
        moveDirection = new Vector3(Vector3.forward.x * Time.deltaTime * forward_back * MovementVelocity, 0, Vector3.right.z * Time.deltaTime * forward_back * MovementVelocity);

        Vector3 FB = transform.TransformDirection(Vector3.forward * forward_back * MovementVelocity * Time.deltaTime);
        Vector3 RL = transform.TransformDirection(Vector3.right * right_left * MovementVelocity * Time.deltaTime);
